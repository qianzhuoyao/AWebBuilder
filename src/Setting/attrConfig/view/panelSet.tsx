...
import {
  IPs,
  updatePanelColor, updatePanelHeight, updatePanelLeft,
  updatePanelLockScale,
  updatePanelLockTransform, updatePanelTop, updatePanelWidth,
...
export function IconParkOutlineUploadWeb(props: SVGProps<SVGSVGElement>) {
  return (<svg xmlns="http://www.w3.org/2000/svg" width="130px" height="130px" viewBox="0 0 48 48" {...props}>
    <g fill="none">
      <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4}
            d="M28 40H7a3 3 0 0 1-3-3V11a3 3 0 0 1 3-3h34a3 3 0 0 1 3 3v12.059M39 41V29m-5 5l5-5l5 5"></path>
      <path stroke="currentColor" strokeWidth={4} d="M4 11a3 3 0 0 1 3-3h34a3 3 0 0 1 3 3v9H4z"></path>
      <circle r={2} fill="currentColor" transform="matrix(0 -1 -1 0 10 14)"></circle>
      <circle r={2} fill="currentColor" transform="matrix(0 -1 -1 0 16 14)"></circle>
    </g>
  </svg>);
}
    ...
    <Popover placement="bottom" showArrow offset={10}>
      ...
      <PopoverContent className="w-[230px]">
        <div className="px-1 py-2 w-full">
          <SketchPicker color={PanelState.panelColor} onChange={onHandleColorChange} />
        </div>
      </PopoverContent>
    </Popover>
  );
