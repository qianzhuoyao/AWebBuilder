...
export const NODE_TYPE_CODE = "IS_A_NODE" as const;
...
export const DEMO_LOCALSTORAGE = "DEMO_LOCALSTORAGE" as const;
export const DEMO_NODE_LOCALSTORAGE = "DEMO_NODE_LOCALSTORAGE" as const;
export const DEMO_STATUS_LOCALSTORAGE = "DEMO_STATUS_LOCALSTORAGE" as const;
export const DEMO_PANEL_LOCALSTORAGE = "DEMO_PANEL_LOCALSTORAGE" as const;
export const DEMO_LOGIC_LOCALSTORAGE = "DEMO_LOGIC_LOCALSTORAGE" as const;
export const DEMO_CAROUSEL_LOCALSTORAGE = "DEMO_CAROUSEL_LOCALSTORAGE" as const;
export const DEMO_CAROUSEL_LOCALSTORAGE_CAROUSEL =
  "DEMO_CAROUSEL_LOCALSTORAGE_CAROUSEL" as const;
export const DEMO_CAROUSEL_LOCALSTORAGE_PREVIEW =
  "DEMO_CAROUSEL_LOCALSTORAGE_PREVIEW" as const;
